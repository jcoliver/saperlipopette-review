...
```{r pkg_dir, echo = F}
pkg_dir <- "/home/jcoliver/Documents/Work/saperlipopette"
```
...
- #### [NAMESPACE](https://docs.ropensci.org/saperlipopette/,
    https://github.com/ropensci-training/saperlipopette/blob/master/NAMESPACE)
...
online documentation: **<https://docs.ropensci.org/saperlipopette/>**

* Is the [documentation](https://ropensci.github.io/dev_guide/building.html#documentation) (installation instructions/vignettes/examples/demos) clear and sufficient?

### test `saperlipopette` function help files:

```{r test-help}
help(package = "saperlipopette")
```
...
### test `saperlipopette` vignettes:

```{r test-vignettes}
vignette(package = "saperlipopette")
```
...
```{r parse-functions}
exports <-ls("package:saperlipopette")
exports
```
